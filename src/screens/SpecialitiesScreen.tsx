...
const SPECIALITIES = [
    {
        title: "Gynaecology",
        price: "₹599",
        image: require('../../public/images/specialities/gynaecology_real.jpg'),
        color: "bg-pink-50/50 dark:bg-pink-900/20",
    },
    {
        title: "Sexology",
        price: "₹599",
        image: require('../../public/images/specialities/sexology_real.jpg'),
        color: "bg-indigo-50/50 dark:bg-indigo-900/20",
    },
    {
        title: "General physician",
        price: "₹499",
        image: require('../../public/images/specialities/general_physician_real.jpg'),
        color: "bg-blue-50/50 dark:bg-blue-900/20",
    },
    {
        title: "Dermatology",
        price: "₹549",
        image: require('../../public/images/specialities/dermatology_real_v2.jpg'),
        color: "bg-teal-50/50 dark:bg-teal-900/20",
    },
    {
        title: "Psychiatry",
        price: "₹599",
        image: require('../../public/images/specialities/psychiatry_real.jpg'),
        color: "bg-green-50/50 dark:bg-green-900/20",
    },
    {
        title: "Stomach and digestion",
        price: "₹499",
        image: require('../../public/images/specialities/stomach_digestion_real.jpg'),
        color: "bg-orange-50/50 dark:bg-orange-900/20",
    },
    {
        title: "Cardiology",
        price: "₹799",
        image: require('../../public/images/specialities/cardiology_real.jpg'),
        color: "bg-red-50/50 dark:bg-red-900/20",
    },
    {
        title: "Pediatrics",
        price: "₹499",
        image: require('../../public/images/specialities/pediatrics_real.jpg'),
        color: "bg-yellow-50/50 dark:bg-yellow-900/20",
    },
    {
        title: "Orthopedics",
        price: "₹599",
        image: require('../../public/images/specialities/orthopedics_real.jpg'),
        color: "bg-orange-50/50 dark:bg-orange-900/20",
    },
    {
        title: "Neurology",
        price: "₹899",
        image: require('../../public/images/specialities/neurology_real.jpg'),
        color: "bg-purple-50/50 dark:bg-purple-900/20",
    },
    {
        title: "Ophthalmology",
        price: "₹499",
        image: require('../../public/images/specialities/ophthalmology_real.jpg'),
        color: "bg-sky-50/50 dark:bg-sky-900/20",
    },
    {
        title: "Dentist",
        price: "₹249",
        image: require('../../public/images/specialities/dentist_v2.jpg'),
        color: "bg-slate-50/50 dark:bg-slate-900/20",
    },
    {
        title: "Dietitian",
        price: "₹349",
        image: require('../../public/images/specialities/dietitian_v2.jpg'),
        color: "bg-lime-50/50 dark:bg-lime-900/20",
    },
    {
        title: "Physiotherapist",
        price: "₹449",
        image: require('../../public/images/specialities/physiotherapist_v2.jpg'),
